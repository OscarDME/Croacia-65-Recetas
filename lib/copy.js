...
export const copy = {
  ...
  story: {
    headline: "Šećer je tihi neprijatelj koji uništava vaše zdravlje",
    intro:
  ...
  finalCta: {
    ...
    subUrgency:
      "Ne propustite priliku da nabavite knjigu recepata uz 75% popusta. Preobrazite svoje zdravlje već sada uz naš cjeloviti jelovnik za 365 dana.",
  ...
  faq: {
    ...
    items: [
      { q: "KAKO ĆU DOBITI RECEPTE?", a: "Sav sadržaj dobit ćete na svoj e-mail." },
      { q: "MOGU LI PRISTUPITI PREKO MOBITELA?", a: "Da, preko mobitela, tableta ili računala." },
  ...
  closing: {
    ...
    trustRow:
      "🔒 100% sigurno plaćanje • ⚡ Trenutni i doživotni pristup • ✅ Posljednja slobodna mjesta",
  },

  footer: {
    brand: "Crearis",
    copyright: "2025 © Sva prava pridržana. Pročitajte našu Politiku privatnosti.",
  },
};